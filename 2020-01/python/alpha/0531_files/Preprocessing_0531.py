...
def DataAnalytics(file_link):
	...
	if(os.path.isfile('./rf3/rf3_c30_m60_main.csv')):
		...
		rf3_c30_m60_pass = pd.read_csv('./rf3/rf3_c30_m60_pass.csv')
		rf3_c30_m60_fail = pd.read_csv('./rf3/rf3_c30_m60_fail.csv')
	else:
		rf3_c30_m60_main = missing_value_refine("./rf3/rf3_c30_m60_main.csv", rf2_c30_main_df, 0.6)
		rf3_c30_m60_pass = missing_value_refine("./rf3/rf3_c30_m60_pass.csv", rf2_c30_pass_df, 0.6)
		rf3_c30_m60_fail = missing_value_refine("./rf3/rf3_c30_m60_fail.csv", rf2_c30_fail_df, 0.6)
	...
	sns.distplot(rf3_c30_m60_fail,
				 color="red", label="e30_m20_fail", bins=10);
	sns.distplot(rf3_c30_m60_pass,
				 color="skyblue", label="e30_m20_pass", bins=10);
